...
// import React, { useMemo } from "react";
// import { PieChart, Pie, Cell, Tooltip,  ResponsiveContainer } from "recharts"; // Legend,
...
const IndustryAllocationPie = ({ holdings, stockData }) => {
  const pieData = useMemo(() => {
    ...
    holdings.forEach((h) => {
      let industry = stockData[h.symbol]?.industry || "Unknown";

      // Normalize industry string: lowercase -> title case
      industry = industry
        .toLowerCase()
        .split(" ")
